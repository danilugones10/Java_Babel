...
public class Ordenador {
	...
	public static String randomMarcaOrdenador() {
		String[] marcasOrdenador = new String[] {"HP", "Asus", "Dell"};
		int random=(int)(Math.random()*marcasOrdenador.length);
		return marcasOrdenador[random];
	}
	...
	public double calcularPrecio() {
		...
		System.out.println(procesador.getPrecio()+placa.getPrecio()+precioPerifericos+precioRams+precioTarjetas);
