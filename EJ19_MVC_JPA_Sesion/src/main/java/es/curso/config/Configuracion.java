...
public class Configuracion {
	...
	public DataSource dataSource() {
		...
		ds.setUrl("jdbc:mysql://localhost:3306/jpa_spring_data_sesion?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
		ds.setUsername("root");
		ds.setPassword("");
		return ds;
	}
